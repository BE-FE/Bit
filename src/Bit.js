(function(global, factory) {
	...
	BitPrototype.writeBit = function(bitInstace, length) {
		if (!this.isBit(bitInstace)) {
			throw new TypeError('Argument 0 must be an instance of Bit');
		}
		arguments[0] = bitInstace.toBitString();
		length == null && (arguments[1] = bitInstace.originalLength);
		return this.writeBitString.apply(this, arguments);
	};
	...
	BitPrototype.writeBitString = function(_S, _L) {
		...
		if (!this.isBitString(_S)) {
			throw new TypeError('Argument 0 Must be an BitString');
			return this;
		}
